  ...
  def create
    ...
    respond_to do |format|
      if @product_brand.save
        format.html { redirect_to product_brand_url(@product_brand), notice: "Product brand was successfully created." }
  ...
  def update
    respond_to do |format|
      if @product_brand.update(product_brand_params)
        format.html { redirect_to product_brand_url(@product_brand), notice: "Product brand was successfully updated." }
